							...
							<form action="{{ isset($guard) ? url($guard.'/login') : route('login') }}" method="POST">
								...
								<div class="form-group">
									<div class="input-group mb-3">
										...
										<input type="email" class="form-control pl-15 bg-transparent text-white plc-white" name="email" id="email" placeholder="email">
									</div>
								</div>
								<div class="form-group">
									<div class="input-group mb-3">
								  ...
								  <div class="row">
									...
									<div class="col-12 text-center">
									  <button type="submit" class="btn btn-info btn-rounded mt-10"> {{ __('Login') }}</button>
									</div>
									<!-- /.col -->
								  </div>
							</form>														
