                    ...
                    <div class="product">
                      <div class="product-micro">
                        <div class="row product-micro-row">
                          <div class="col col-xs-5">
                            <div class="product-image">
                              <div class="image"> <a href="#"> <img src=" {{ asset( $special_deal->product_thambnail ) }}" alt=""> </a> </div>
                              <!-- /.image --> 
                          ...
                          <div class="col col-xs-7">
                            <div class="product-info">
                              <h3 class="name"><a href="#"> {{ $special_deal->product_name }} </a></h3>
                              <div class="rating rateit-small"></div>
                              <div class="product-price"> <span class="price"> {{ $special_deal->discount_price }} </span> </div>
                              <!-- /.product-price --> 
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder"> 
          ...
          <div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
            ...
            <div class="tab-content outer-top-xs">
              <div class="tab-pane in active" id="all">
                <div class="product-slider">
                  <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                      ...
                      <div class="products">
                        <div class="product">
                          ...
                          <div class="product-info text-left">
                            <h3 class="name"><a href="{{ url('product/detail/'. $product->id ) }}">{{ $product->product_name }}</a></h3>
                            <div class="rating rateit-small"></div>
                    ...
                    @endforeach    {{-- end all product loop --}}
              ...
              {{-- start category wise product show  --}}
              @foreach($categories as $category) 
                ...
                <div class="tab-pane" id="category{{ $category->id }}">
                  ...
                  <div class="product-slider">
                    <div class="owl-carousel home-owl-carousel custom-carousel owl-theme" data-item="4">
                      ...
                      <h5 class="text-danger"> No  Product Fround</h5> --}}
                      @endforeach    {{-- end all product loop --}}
                      {{-- @endforelse end foreach category wise product show --}}
                ...
                <!-- /.tab-pane -->
                @endforeach {{-- end foreach category wise product show --}}
            ...
            <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
              ...
              <div class="item item-carousel">
                <div class="products">
                  <div class="product">
                    <div class="product-image">
                      <div class="image"> <a href="detail.html"><img  src="{{ asset($featured->product_thambnail ) }}"alt=""></a> </div>
                      <!-- /.image --> --}}
                    ...
                    {{-- <div class="product-info text-left">
                      <h3 class="name"><a href="detail.html">{{ $featured->product_name }}</a></h3>
                      <div class="rating rateit-small"></div>
                      <div class="description"></div>
                      <div class="product-price"> <span class="price"> {{ $featured->discount_price }} </span> 
                        <span class="price-before-discount">{{ $featured->selling_price }}</span> </div>
                      <!-- /.product-price --> 
                      ...
                      <div class="action">
                        <ul class="list-unstyled">
                          <li class="add-cart-button btn-group">
                            ...
                            type="button"  onclick="productView(this.id)"  id="{{ $product->id }}" title="Add Cart"> 
