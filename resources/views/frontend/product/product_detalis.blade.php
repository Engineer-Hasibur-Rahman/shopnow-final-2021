            ...
            <div id="owl-single-product-thumbnails"> 
                ...
                <div class="item">
                    <a class="horizontal-thumb active" data-target="#owl-single-product" data-slide="1" href="#slide{{ $multiimg->id }}">
						...
						alt="" src="{{ asset($multiimg->photo_name) }}" 
					...
					<div class="product">		
						...
						<div class="product-info text-left">
							...
							<div class="product-price">	
								...
								<span class="price">{{ $relatedProduct_re->discount_price  }}	</span>
								<span class="price-before-discount">{{ $relatedProduct_re->selling_price  }}</span>
