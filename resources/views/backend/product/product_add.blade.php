            ...
            <div class="row"> <!-- start 3rd row  -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                         <input type="text" name="product_tags" value="Lorem,Ipsum,Amet" data-role="tagsinput" class="form-control" required="" > </div>
            ...
            <div class="row"> <!-- start 4th row  -->
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="product_size" value="small,large,mediem" data-role="tagsinput" class="form-control" required=""> </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                         <input type="text" name="product_color" value="Red,Green,Black" data-role="tagsinput" class="form-control" required="" > </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <h5>Product Short Descraption<span class="text-danger">*</span></h5>
                          ...
                          <textarea name="product_short_descp" rows="18"  id="textarea" class="form-control" required placeholder="Textarea text"></textarea>
